...
# [Firebase configuration, email configuration, skill definitions, question bank, messages remain unchanged]
...
# Cosine similarity evaluation helper
...
# Updated evaluate_answer with cosine similarity fallback
